...
|:----------|:------------|
|Informe | Se podrá encontrar el paso a paso de la creación de la base de datos realizada en el proyecto.|
| Creación del esquema y tablas| Contiene el script .sql con la creación del esquema y la creación de las tablas.|
